                ...
                <div class="panel-body">
                    <div class="col-lg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <asp:LinkButton ID="btnChangeFilter" OnClick="btnChangeFilter_Click" class="btn btn-primary" runat="server"><i class="fa fa-filter" aria-hidden="true"></i>&nbsp;Change Filter</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
